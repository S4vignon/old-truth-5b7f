...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/old-truth-5b7f)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/old-truth-5b7f
```

A live public deployment of this template is available at [https://old-truth-5b7f.templates.workers.dev](https://old-truth-5b7f.templates.workers.dev)
